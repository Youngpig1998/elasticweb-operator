...
// +kubebuilder:webhook:path=/mutate-elasticweb-example-com-v1-elasticweb,mutating=true,failurePolicy=fail,sideEffects=None,groups=elasticweb.example.com,resources=elasticwebs,verbs=create;update,versions=v1,name=melasticweb.kb.io,admissionReviewVersions={v1,v1beta1}
...
// +kubebuilder:webhook:path=/validate-elasticweb-example-com-v1-elasticweb,mutating=false,failurePolicy=fail,sideEffects=None,groups=elasticweb.example.com,resources=elasticwebs,verbs=create;update,versions=v1,name=velasticweb.kb.io,admissionReviewVersions={v1,v1beta1}
